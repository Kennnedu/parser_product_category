class ProductExtractor
  ...
  def parse_price
    @result[:price] = @page.xpath(".//ul[@id='product-select-list']/li[@data-product_id ='#{@id}']/span[@class='price']").text
  ...
  def parse_delivery_time
   @result[:delivery_time] = @page.xpath(".//div[@class='product_#{@id}_details product_details_list']/div/p[@class='notification_in-stock']")
                              .text.to_s.strip
  end
